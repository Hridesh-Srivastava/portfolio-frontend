...
const featuredProjects = [
  {
    ...
    description: "I developed a comprehensive alumni portal for SST, SRHU to strengthen the connection between alumni and current students while fostering long-term engagement. The platform is designed with a clean and user-friendly interface.",
  ...
  },
  {
    ...
    description: "A clean corporate website for Oddiant Techlabs that showcases their core offerings—IT consulting, HR consulting, recruitment & staffing, ATS, Assessment Portal and personality development—with clear CTAs, trust metrics, and lead-capture to drive enquiries.",
  ...
  },
  {
    ...
    description: "This project is a full-stack quiz platform for SST College, helping students practice and evaluate their knowledge in computer science. It provides an interactive, responsive interface with quizzes across multiple categories and ensures smooth performance with accurate scoring.",
